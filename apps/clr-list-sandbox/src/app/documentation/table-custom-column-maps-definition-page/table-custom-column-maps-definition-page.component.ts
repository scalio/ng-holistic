...
@Component({
    selector: 'hlc-clr-sandbox-table-custom-column-maps-definition-page',
    templateUrl: './table-custom-column-maps-definition-page.component.html',
    styleUrls: ['./table-custom-column-maps-definition-page.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class TableCustomColumnMapsDefinitionPageComponent {
