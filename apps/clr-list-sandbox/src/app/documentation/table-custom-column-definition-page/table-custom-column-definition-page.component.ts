...
<ng-template hlcClrCustomCell="custom" let-row="row" let-val">
    <app-status [status]="val"></apps-status>
</ng-template>
`;
...
@Component({
    selector: 'hlc-clr-sandbox-table-custom-column-definition-page',
    templateUrl: './table-custom-column-definition-page.component.html',
    styleUrls: ['./table-custom-column-definition-page.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class TableCustomColumnDefinitionPageComponent {
